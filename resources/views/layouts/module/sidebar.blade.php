<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html"
            ...
            <span class="ms-1 font-weight-bold">Rokata.id Dashboard</span>
        </a>
    </div>
    <hr class="horizontal dark mt-0">

    <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">MANAJEMEN PRODUK</h6>

    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link  {{ Request::is('administrator') ? ' active' : null }}"
            ...
            <li class="nav-item">
                <a class="nav-link  {{ Request::is('administrator/category*') ? ' active' : null }}"
            ...
            <li class="nav-item">
                <a class="nav-link  {{ Request::is('administrator/product*') ? ' active' : null }}"
            ...
            <li class="nav-item">
                <a class="nav-link  {{ Request::is('administrator/orders*') ? ' active' : null }}"
            ...
            <li class="nav-item">
                <a class="nav-link  {{ Request::is('administrator/reports/order*') ? ' active' : null }}"
